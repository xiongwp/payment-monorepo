...
CREATE TABLE IF NOT EXISTS `account_${TABLE}` (
...
-- ============================================
CREATE TABLE IF NOT EXISTS `account_transaction_${TABLE}` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ============================================
CREATE TABLE IF NOT EXISTS `accounting_voucher_${TABLE}` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ============================================
CREATE TABLE IF NOT EXISTS `account_balance_snapshot_${TABLE}` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    `account_no` VARCHAR(64) NOT NULL COMMENT '账户号',
...
-- ============================================
CREATE TABLE IF NOT EXISTS `day_cut_control_${TABLE}` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- 全局表，不分库分表
-- ============================================
CREATE TABLE IF NOT EXISTS `async_task_${TABLE}` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ============================================
CREATE TABLE IF NOT EXISTS `tcc_transaction_${TABLE}` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ============================================
CREATE TABLE IF NOT EXISTS `freeze_compensate_outbox_${TABLE}` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- 用于日切等场景的分布式锁
-- ============================================
CREATE TABLE IF NOT EXISTS `distributed_lock_${TABLE}` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ============================================
CREATE TABLE IF NOT EXISTS `merchant_info_${TABLE}` (
...
CREATE TABLE IF NOT EXISTS `transaction_order_${TABLE}` (
    `id`             BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ============================================
CREATE TABLE IF NOT EXISTS `transaction_order_extra_${TABLE}` (
    `id`         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ============================================
CREATE TABLE IF NOT EXISTS `account_balance_buffer_${TABLE}` (
    `account_no`       VARCHAR(64)   NOT NULL COMMENT '账户号',
...
-- 相关记录共享分片，避免跨分片事务。
-- ============================================
CREATE TABLE IF NOT EXISTS `tcc_coordinator_${TABLE}` (
...
-- ============================================
CREATE TABLE IF NOT EXISTS `batch_order_${TABLE}` (
    `id`              BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ============================================
CREATE TABLE IF NOT EXISTS `settlement_outbox_${TABLE}` (
    `id`               BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',

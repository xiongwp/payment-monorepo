// LanguageSwitcher — 顶部导航的语言切换下拉（与 accounting-admin-web 复用同款 UI）。
//
...
//   2. localStorage["i18nextLng"] = code（i18next-browser-languagedetector 自动持久化）
//   3. antd ConfigProvider 通过 useAntdLocale hook 拿当前语言 → 切换 antd 内建文案

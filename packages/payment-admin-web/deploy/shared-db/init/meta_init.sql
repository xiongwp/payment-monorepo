...
-- ════════════════════════════════════════════════════════════════════════
-- split_payment — split-payment 服务 meta 库 (12 张表 + split_user 账号).
-- 跟 paychan_meta / order_meta 同居 shared-meta. IF NOT EXISTS 全员幂等.
-- ════════════════════════════════════════════════════════════════════════
CREATE DATABASE IF NOT EXISTS `split_payment` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE USER IF NOT EXISTS 'split_user'@'%' IDENTIFIED WITH mysql_native_password BY 'password';
ALTER USER 'split_user'@'%' IDENTIFIED WITH mysql_native_password BY 'password';

module github.com/xiongwp/order-core

go 1.25.0

// order-core 的一个 channel.PaymentChannel 实现（internal/channel/paymentcoreclient）
// 直接拨 payment-core gRPC，所以依赖 payment-core 的 pb.go。本地 + docker 构建走
// 同级目录 replace；CI/发布时可改为具体 tag。payment-core 自己还 replace 了
// payment-channel / kms-manage，这里也一并挂上，保证没 go.work 的容器里也能 build。
//
...
require (
	...
	github.com/xiongwp/card-center v0.0.1
...
require (
	...
	github.com/xiongwp/risk-manage v0.0.1 // indirect
